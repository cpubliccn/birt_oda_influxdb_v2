...
public class ResultSetMetaData implements IResultSetMetaData
{
	...
	public ResultSetMetaData(String[] colNames) {
	...
	{
//        if( getColumnName(index).equalsIgnoreCase("time") )
//            return java.sql.Types.DATE;   // as defined in data set extension manifest
